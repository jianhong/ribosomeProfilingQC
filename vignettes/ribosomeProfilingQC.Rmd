...
(ORF) annotation. 
This sample data is mapped to Zebrafish UCSC danRer10 assembly, 
...
If you see warning or error message complain about the disagreement of
chromosome sequences, Please make sure you are using the TxDb object with
...
## Following code will plot the ORFscores vs coerage.
...
# write.csv(cbind(cnts$annotation, cnts$RPFs, cnts$mRNA),
#           "counts.csv")
```
